...
{
	//v Loads ========================================================
	Assets::loadShader("Sprite.vert", "Sprite.frag", "", "", "", "Sprite");
	Assets::loadShader("BasicMesh.vert", "BasicMesh.frag", "", "", "", "BasicMesh");
	Assets::loadShader("Phong.vert", "Phong.frag", "", "", "", "Phong");
